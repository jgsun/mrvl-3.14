...
#define POWER_MODE_SYS_SLEEP POWER_MODE_SYS_SLEEP_VCTCXO
...
#define PM_QOS_CPUIDLE_BLOCK_DDR	POWER_MODE_SYS_SLEEP_VCTCXO
#define PM_QOS_CPUIDLE_BLOCK_UDR_VCTCXO	POWER_MODE_SYS_SLEEP_VCTCXO_OFF
