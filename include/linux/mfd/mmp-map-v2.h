/*
 * Marvell MAP(Marvell Audio processor) 2.0 Interface
 *
...
#ifndef __LINUX_MFD_MMP_MAP_2_H
#define __LINUX_MFD_MMP_MAP_2_H
...
#define PMUA_PWR_CTRL_REG		(0xd8)
#define PMUA_PWR_BLK_TMR		(0xdc)
#define PMUA_PWR_STATUS_REG		(0xf0)
...
#define MAP_I2S1_I2S4_CTRL_REG		0x08
#define MAP_I2S2_CTRL_REG		0x0c
#define MAP_I2S3_CTRL_REG		0x10
#define MAP_I2S5_CTRL_REG		0x14
...
/* bit clock divider */
#define MAP_I2S2_BCLK_DIV		0x74
#define MAP_I2S3_BCLK_DIV		0x78
#define MAP_I2S5_BCLK_DIV		0x7c
#define MAP_I2S_OUT_BCLK_DIV		0x80
#define MAP_I2S_48K_BCLK_DIV		0x84
#define MAP_I2S_44P1K_BCLK_DIV		0x88
#define MAP_FM_BCLK_DIV			0x90
#define MAP_PDM_BCLK_DIV		0x94
#define MAP_DMIC12_CLK_DIV		0x98
#define MAP_DMIC34_CLK_DIV		0x9c
...
/* data path ctrl regitser2 */
#define FM_BT_SEL			(1 << 25)
/* PDM/DMIC register */
#define PDM_CTRL			0xc0
#define DMIC_CTRL			0xa8
/* PDM/DMIC setting */
#define PDM_OUT_ENABLE			(1 << 1)
#define PDM_OUT_MODE			(1 << 2)
#define PDM_OUT_AUDIO			(1 << 4)
#define DMIC12_ENABLE			(1 << 0)
#define DMIC34_ENABLE			(1 << 8)
...
#define I2S_OUT_RESET	(1 << 22)
#define	DMIC_RESET	(1 << 28)
#define	PDM_RESET	(1 << 27)
#define	I2S6_RESET	(1 << 25)
#define I2S5_RESET	(1 << 24)
#define TDM_RESET	(1 << 23)
#define I2S4_RESET	(1 << 21)
#define I2S3_RESET	(1 << 20)
#define I2S2_RESET	(1 << 19)
#define I2S1_RESET	(1 << 18)
#define	ASRC3_RESET	(1 << 17)
#define ASRC2_RESET	(1 << 16)
#define ASRC1_5RESET	(1 << 15)
#define ASRC1_4RESET	(1 << 14)
#define ASRC1_3RESET	(1 << 13)
#define ASRC1_2RESET	(1 << 12)
#define ASRC1_1RESET	(1 << 11)
...
#define MAP_LRCLK1_POL	(0x3 << 10)
#define MAP_LRCLK4_POL	(0x3 << 14)
...
/*
 * define audio clk source.
 * APLL_32K: 32k audio PLL
 * APLL_26M: 26m audio PLL
 * VCTCXO_26M: 26m vctcxo
