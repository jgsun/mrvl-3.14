...
static struct mmp_clk_mix_clk_table gc3d_pptbl_pxa1936_TSMC_B0[] = {
	...
	{.rate = 528000000, .parent_index = 2, .xtc = 0x00055555, },
	{.rate = 624000000, .parent_index = 1, .xtc = 0x00055555, },
	{.rate = 705000000, .parent_index = 3, .xtc = 0x00066655, },
	{.rate = 832000000, .parent_index = 0, .xtc = 0x00066655, },
};

static struct mmp_clk_mix_clk_table gc3d_pptbl_pxa1956[] = {
	{.rate = 156000000, .parent_index = 1, .xtc = 0x00000144, },
	{.rate = 312000000, .parent_index = 1, .xtc = 0x00000144, },
	{.rate = 416000000, .parent_index = 0, .xtc = 0x00055544, },
	{.rate = 624000000, .parent_index = 1, .xtc = 0x00055555, },
...
static struct mmp_clk_mix_config gc3d_mix_config_pxa1956 = {
	.reg_info = DEFINE_MIX_REG_INFO(3, 12, 3, 18, 15),
	.table = gc3d_pptbl_pxa1956,
	.table_size = ARRAY_SIZE(gc3d_pptbl_pxa1956),
};
...
static struct mmp_clk_mix_clk_table gcsh_pptbl_pxa1956[] = {
	{.rate = 156000000, .parent_index = 1, },
	{.rate = 312000000, .parent_index = 1, },
	{.rate = 416000000, .parent_index = 0, },
	{.rate = 624000000, .parent_index = 1, },
...
static struct mmp_clk_mix_config gcsh_mix_config_pxa1956 = {
	.reg_info = DEFINE_MIX_REG_INFO(3, 28, 3, 21, 31),
	.table = gcsh_pptbl_pxa1956,
	.table_size = ARRAY_SIZE(gcsh_pptbl_pxa1956),
};
...
static struct mmp_clk_mix_clk_table gcbus_pptbl_pxa1956[] = {
	{.rate = 78000000, .parent_index = 1, },
	{.rate = 156000000, .parent_index = 1, },
	{.rate = 208000000, .parent_index = 0, },
	{.rate = 264250000, .parent_index = 2, },
	{.rate = 312000000, .parent_index = 1, },
	{.rate = 416000000, .parent_index = 0, },
};
...
static struct mmp_clk_mix_config gcbus_mix_config_pxa1956 = {
	.reg_info = DEFINE_MIX_REG_INFO(3, 17, 2, 20, 16),
	.table = gcbus_pptbl_pxa1956,
	.table_size = ARRAY_SIZE(gcbus_pptbl_pxa1956),
};
...
static void pxa1936_axi_periph_clk_init(struct pxa1936_clk_unit *pxa_unit)
{
	...
	if (cpu_is_pxa1956()) {
		gc3d_mix_config_pxa1956.reg_info.reg_clk_ctrl = pxa_unit->apmu_base + APMU_GC;
		gc3d_mix_config_pxa1956.reg_info.reg_clk_xtc = pxa_unit->ciu_base + GPU_XTC;
	...
	if (cpu_is_pxa1956()) {
		gcsh_mix_config_pxa1956.reg_info.reg_clk_ctrl = pxa_unit->apmu_base + APMU_GC;
