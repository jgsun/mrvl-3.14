...
int ddr_800M_tsmc_b0_svc[] = {1050, 950, 950, 950, 950, 950, 950, 950,
963, 950, 963, 975, 1000, 1013, 1025, 1050};
int ddr_800M_tsmc_b0_new_svc[] = {1088, 975, 975, 975, 988, 988, 1000, 1000, 1013,
1013, 1025, 1038, 1050, 1063, 1075, 1088};

int tsmc_b0_1p8g_svc[] = {1300, 1175, 1188, 1200, 1213, 1225, 1238, 1250,
1250, 1263, 1288, 1300, 1300, 1300, 1300, 1300};
int tsmc_a0_1p8g_svc[] = {1300, 1175, 1188, 1200, 1213, 1225, 1238, 1250,
1250, 1263, 1288, 1300, 1238, 1263, 1288, 1300};
int tsmc_b0_new_1p8g_svc[] = {1400, 1200, 1200, 1213, 1225, 1238, 1238,
1250, 1263, 1275, 1288, 1300, 1325, 1350, 1375, 1400};
	...
	unsigned int uiLPP_LoPP_Profile, unsigned int uiPCPP_Profile)
{
	...
	if (uiPCPP_Profile == 0) {
		if (svc_version == SVC_TSMC_B0_NEW)
			min_cp_voltage = 975;
		else
			min_cp_voltage = 963;
	} else if (uiPCPP_Profile == 1) {
		if (svc_version == SVC_TSMC_B0_NEW)
			min_cp_voltage = 1000;
		else
			min_cp_voltage = 988;
	} else if (uiPCPP_Profile == 3)
		min_cp_voltage = 1038;
	else
		min_cp_voltage = 963;
	...
	if (uiGc3d_Vlevel == 0) {
		if (svc_version == SVC_TSMC_B0_NEW)
			...
			min_gc_voltage = 950;
	} else if (uiGc3d_Vlevel == 1) {
		if (svc_version == SVC_TSMC_B0_NEW)
			min_gc_voltage = 1000;
		else
			min_gc_voltage = 975;
	} else if (uiGc3d_Vlevel == 3)
		min_gc_voltage = 1050;
	else
		min_gc_voltage = 950;
...
static int __init __init_read_droinfo(void)
{
	...
	unsigned int uiProfileFuses, uiFabRev, guiProfile;
	...
	unsigned int uiskusetting = 0, uiGc3d_Vlevel = 0;
	unsigned int uiLPP_LoPP_Profile = 0, uiPCPP_Profile = 0, uiNegEdge = 0;
	...
	pr_info("uiYldTableEn %d,uiGc3d_Vlevel %d, uiLPP_LoPP_Profile %d\n",
	uiYldTableEn, uiGc3d_Vlevel, uiLPP_LoPP_Profile);
	pr_info("uiPCPP_Profile %d, uiNegEdge %d\n", uiPCPP_Profile, uiNegEdge);
...
static unsigned long freqs_cmb_1936_tsmc_b0_new[][VM_RAIL_MAX][VL_MAX] = {
	[0] = {
		/* LV0,    LV1,    LV2,    LV3,    LV4,    LV5,    LV6,    LV7 */
		{312000, 416000, 416000, 624000, 624000, 832000, 832000, 1248000}, /* CLUSTER0 */
		{312000, 624000, 624000, 832000, 832000, 1248000, 1491000, 1491000}, /* CLUSTER1 */
		{624000, 624000, 624000, 624000, 624000, 667000, 667000, 797000}, /* DDR */
		{156000, 208000, 208000, 312000, 312000, 312000, 312000, 312000}, /* AXI */
		{0, 0, 528000, 624000, 705000, 832000, 832000, 832000}, /* GC3D */
		{0, 208000, 208000, 312000, 312000, 416000, 416000, 416000}, /* GC2D */
		{0, 0, 528000, 624000, 705000, 832000, 832000, 832000}, /* GCSHADER */
		{0, 312000, 416000, 416000, 416000, 416000, 416000, 416000}, /* GCACLK */
		{208000, 312000, 312000, 528000, 528000, 528000, 528000, 528000}, /* VPU */
		{0, 208000, 208000, 312000, 416000, 499000, 499000, 499000}, /* ISP */
		sdh_dvfs,
	},
	[1] = {
		/* LV0,    LV1,    LV2,    LV3,    LV4,    LV5,    LV6,    LV7 */
		{312000, 624000, 624000, 624000, 624000, 832000, 832000, 1248000}, /* CLUSTER0 */
		{0, 832000, 832000, 832000, 1057000, 1491000, 1491000, 1491000}, /* CLUSTER1 */
		{624000, 624000, 624000, 624000, 624000, 667000, 667000, 797000}, /* DDR */
		{208000, 312000, 312000, 312000, 312000, 312000, 312000, 312000}, /* AXI */
		{0, 624000, 624000, 624000, 705000, 832000, 832000, 832000}, /* GC3D */
		{312000, 312000, 312000, 312000, 312000, 416000, 416000, 416000}, /* GC2D */
		{0, 624000, 624000, 624000, 705000, 832000, 832000, 832000}, /* GCSHADER */
		{312000, 416000, 416000, 416000, 416000, 416000, 416000, 416000}, /* GCACLK */
	...
	[4] = {
		...
		{624000, 624000, 624000, 624000, 624000, 667000, 667000, 797000}, /* DDR */
		{208000, 312000, 312000, 312000, 312000, 312000, 312000, 312000}, /* AXI */
		{0, 528000, 528000, 624000, 705000, 832000, 832000, 832000}, /* GC3D */
		{208000, 312000, 312000, 312000, 312000, 416000, 416000, 416000}, /* GC2D */
		{0, 528000, 528000, 624000, 705000, 832000, 832000, 832000}, /* GCSHADER */
		{312000, 416000, 416000, 416000, 416000, 416000, 416000, 416000}, /* GCACLK */
		{416000, 528000, 528000, 528000, 528000, 528000, 528000, 528000}, /* VPU */
		{208000, 312000, 312000, 312000, 416000, 499000, 499000, 499000}, /* ISP */
		sdh_dvfs,
	...
	[5] = {
		/* LV0,    LV1,    LV2,    LV3,    LV4,    LV5,    LV6,    LV7 */
		{312000, 416000, 416000, 624000, 624000, 832000, 832000, 1248000}, /* CLUSTER0 */
		{0, 624000, 624000, 832000, 832000, 1491000, 1491000, 1491000}, /* CLUSTER1 */
		{624000, 624000, 624000, 624000, 624000, 667000, 667000, 797000}, /* DDR */
		{208000, 208000, 208000, 312000, 312000, 312000, 312000, 312000}, /* AXI */
		{0, 528000, 528000, 624000, 705000, 832000, 832000, 832000}, /* GC3D */
		{208000, 312000, 312000, 312000, 312000, 416000, 416000, 416000}, /* GC2D */
		...
		{312000, 528000, 528000, 528000, 528000, 528000, 528000, 528000}, /* VPU */
		{208000, 312000, 312000, 312000, 416000, 499000, 499000, 499000}, /* ISP */
		sdh_dvfs,
	},
	[6] = {
		...
		{624000, 624000, 624000, 624000, 624000, 667000, 667000, 797000}, /* DDR */
		{208000, 208000, 208000, 312000, 312000, 312000, 312000, 312000}, /* AXI */
		{0, 528000, 528000, 705000, 705000, 832000, 832000, 832000}, /* GC3D */
		{208000, 312000, 312000, 312000, 312000, 416000, 416000, 416000}, /* GC2D */
		{0, 528000, 528000, 705000, 705000, 832000, 832000, 832000}, /* GCSHADER */
		{0, 416000, 416000, 416000, 416000, 416000, 416000, 416000}, /* GCACLK */
		{312000, 528000, 528000, 528000, 528000, 528000, 528000, 528000}, /* VPU */
		{208000, 312000, 312000, 312000, 416000, 499000, 499000, 499000}, /* ISP */
		sdh_dvfs,
	...
	[8] = {
		...
		{0, 416000, 416000, 416000, 416000, 416000, 416000, 416000}, /* GCACLK */
		{312000, 416000, 416000, 528000, 528000, 528000, 528000, 528000}, /* VPU */
		{208000, 208000, 208000, 312000, 416000, 499000, 499000, 499000}, /* ISP */
		sdh_dvfs,
	},
	[9] = {
		/* LV0,    LV1,    LV2,    LV3,    LV4,    LV5,    LV6,    LV7 */
	...
	[10] = {
		...
		{0, 312000, 528000, 624000, 705000, 832000, 832000, 832000}, /* GCSHADER */
		{0, 312000, 416000, 416000, 416000, 416000, 416000, 416000}, /* GCACLK */
		{312000, 312000, 312000, 528000, 528000, 528000, 528000, 528000}, /* VPU */
		{208000, 208000, 208000, 312000, 416000, 499000, 499000, 499000}, /* ISP */
		sdh_dvfs,
	},
	[11] = {
	...
	[12] = {
		/* LV0,    LV1,    LV2,    LV3,    LV4,    LV5,    LV6,    LV7 */
		{312000, 416000, 416000, 624000, 624000, 832000, 832000, 1248000}, /* CLUSTER0 */
		{0, 624000, 624000, 832000, 1057000, 1248000, 1491000, 1491000}, /* CLUSTER1 */
		{624000, 624000, 624000, 624000, 624000, 667000, 667000, 797000}, /* DDR */
		{208000, 208000, 208000, 312000, 312000, 312000, 312000, 312000}, /* AXI */
		{0, 416000, 528000, 624000, 705000, 832000, 832000, 832000}, /* GC3D */
		{0, 208000, 208000, 312000, 312000, 416000, 416000, 416000}, /* GC2D */
...
static int vm_millivolts_1936_svc_tsmc_b0_new[][VL_MAX] = {
	/*LV0,  LV1,  LV2,  LV3,  LV4,  LV5,  LV6,  LV7 */
	{975, 1025, 1050, 1088, 1113, 1175, 1250, 1350},/* Profile0 */
	{950, 975, 975, 975, 988, 1050, 1038, 1163},/* Profile1 */
	{950, 975, 975, 975, 988, 1063, 1038, 1175},/* Profile2 */
	{950, 975, 975, 975, 988, 1063, 1050, 1175},/* Profile3 */
	{950, 975, 975, 988, 1000, 1075, 1050, 1188},/* Profile4 */
	{950, 975, 975, 988, 1000, 1075, 1063, 1200},/* Profile5 */
	{950, 975, 975, 1000, 1013, 1075, 1075, 1213},/* Profile6 */
	{950, 975, 975, 1000, 1013, 1088, 1088, 1225},/* Profile7 */
	{950, 975, 975, 1013, 1025, 1088, 1100, 1225},/* Profile8 */
	{950, 975, 988, 1013, 1025, 1100, 1100, 1238},/* Profile9 */
	{950, 975, 988, 1025, 1038, 1100, 1125, 1263},/* Profile10 */
	{950, 988, 1000, 1038, 1050, 1113, 1150, 1275},/* Profile11 */
	{950, 1000, 1013, 1050, 1075, 1125, 1175, 1300},/* Profile12 */
	{950, 1013, 1025, 1063, 1088, 1138, 1200, 1313},/* Profile13 */
	{963, 1013, 1038, 1075, 1100, 1163, 1225, 1338},/* Profile14 */
	{975, 1025, 1050, 1088, 1113, 1175, 1250, 1350},/* Profile15 */
};
...
#define cp_lv5 cp_msa(VL1, VL2, VL5, VL1)
#define cp_lv6 cp_msa(VL1, VL3, VL5, VL1)
#define cp_lv7 cp_msa(VL1, VL2, VL5, VL2)
#define cp_lv8 cp_msa(VL1, VL1, VL5, VL1)
...
static struct cpmsa_dvc_info cpmsa_dvc_info_1936tsmc_b0[NUM_PROFILES] = {
	[0] = cp_lv2,
	[1] = cp_lv6,
	[2] = cp_lv6,
	[3] = cp_lv6,
...
static struct cpmsa_dvc_info cpmsa_dvc_info_1936tsmc_b0_new[NUM_PROFILES] = {
	[0] = cp_lv3,
	[1] = cp_lv8,
	[2] = cp_lv8,
	[3] = cp_lv8,
...
void adjust_ddr_svc(void)
{
	...
	if (svc_version == SVC_1_11)
		...
		ddr_voltage = ddr_800M_tsmc_b0_new_svc[uiprofile];
...
void adjust_1p8g_svc(void)
{
	...
	if (helan3_maxfreq == CORE_1p8G) {
		if (svc_version == SVC_TSMC_B0)
			...
			cluster1_voltage = tsmc_b0_new_1p8g_svc[uiprofile];
...
int handle_svc_table(void)
{
	...
	if (svc_version == SVC_1_11) {
		...
		millivolts = vm_millivolts_1936_svc_tsmc_b0_new[uiprofile];
		freqs_cmb = freqs_cmb_1936_tsmc_b0_new[uiprofile];
	}
...
void handle_svc_cp_table(void)
{
	...
	if (uiYldTableEn == 1) {
		if (svc_version == SVC_1_11)
			...
			cpmsa_dvc_info_cp_temp = cpmsa_dvc_info_1936tsmc_b0;
		else if (svc_version == SVC_TSMC_B0_NEW)
			cpmsa_dvc_info_cp_temp = cpmsa_dvc_info_1936tsmc_b0_new;
		...
		if (svc_version == SVC_1_11)
			...
			fillcpdvcinfo(&cpmsa_dvc_info_1936tsmc_b0[uiprofile]);
		else if (svc_version == SVC_TSMC_B0_NEW)
			fillcpdvcinfo(&cpmsa_dvc_info_1936tsmc_b0_new[uiprofile]);
	}
}
