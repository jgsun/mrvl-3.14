...
int tsmc_b0_1p8g_svc[] = {1363, 1163, 1175, 1188, 1200, 1212, 1225, 1238,
1250, 1250, 1263, 1288, 1300, 1325, 1338, 1363};
...
unsigned int convert_svc_version(unsigned int uiSVCRev, unsigned int uiFabRev)
{
	if (((chip_stepping == TSMC_28LP_B020A) ||
		(chip_stepping == TSMC_28LP_B121A)) && (helan3_maxfreq == CORE_1p8G))
		svc_version = SVC_TSMC_B0_1p8G;
	else if ((chip_stepping == TSMC_28LP_B020A) ||
		(chip_stepping == TSMC_28LP_B121A))
		svc_version = SVC_TSMC_B0;
	else if (helan3_maxfreq == CORE_1p8G)
...
static unsigned long freqs_cmb_1936_tsmc_b0[][VM_RAIL_MAX][VL_MAX] = {
	[0] = {
		...
		{624000, 624000, 624000, 624000, 624000, 624000, 667000, 797000}, /* DDR */
		{208000, 208000, 208000, 312000, 312000, 312000, 312000, 312000}, /* AXI */
		{0, 0, 528000, 624000, 624000, 705000, 832000, 832000}, /* GC3D */
		{0, 208000, 208000, 312000, 312000, 416000, 416000, 416000}, /* GC2D */
		{0, 0, 528000, 624000, 624000, 705000, 832000, 832000}, /* GCSHADER */
		{0, 312000, 312000, 416000, 416000, 416000, 416000, 416000}, /* GCACLK */
		{312000, 312000, 416000, 500000, 500000, 528000, 528000, 528000}, /* VPU */
		{0, 208000, 312000, 416000, 416000, 499000, 499000, 499000}, /* ISP */
		sdh_dvfs,
...
static int vm_millivolts_1936_svc_tsmc_b0[][VL_MAX] = {
	/*LV0,  LV1,  LV2,  LV3,  LV4,  LV5,  LV6,  LV7 */
	{988, 1025, 1050, 1100, 1100, 1175, 1250, 1350},/* Profile0 */
	{950, 975, 975, 1000, 1000, 1025, 1013, 1138},/* Profile1 */
	{950, 975, 975, 1000, 1000, 1038, 1025, 1150},/* Profile2 */
	{950, 975, 975, 1000, 1000, 1038, 1038, 1163},/* Profile3 */
	{950, 975, 975, 1000, 1000, 1050, 1050, 1175},/* Profile4 */
	{950, 975, 975, 1000, 1000, 1050, 1050, 1188},/* Profile5 */
	{950, 975, 975, 1000, 1013, 1063, 1063, 1200},/* Profile6 */
	{950, 975, 975, 1000, 1013, 1063, 1075, 1213},/* Profile7 */
	{950, 975, 988, 1013, 1025, 1075, 1088, 1225},/* Profile8 */
	{950, 975, 988, 1013, 1025, 1088, 1100, 1238},/* Profile9 */
	{950, 975, 988, 1025, 1038, 1088, 1113, 1250},/* Profile10 */
	{950, 975, 1000, 1038, 1050, 1113, 1138, 1275},/* Profile11 */
	{950, 988, 1013, 1050, 1063, 1125, 1163, 1288},/* Profile12 */
	{963, 1000, 1025, 1063, 1075, 1150, 1188, 1300},/* Profile13 */
	{975, 1000, 1038, 1075, 1088, 1163, 1213, 1325},/* Profile14 */
	{988, 1025, 1050, 1100, 1100, 1175, 1250, 1350},/* Profile15 */
};
