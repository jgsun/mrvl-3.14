...
int ddr_800M_tsmc_b0_v17_svc[] = {1050, 950, 950, 950, 950, 950, 950, 950,
...
int tsmc_b0_v17_1p8g_svc[] = {1400, 1200, 1200, 1213, 1225, 1238, 1238,
...
static unsigned long freqs_cmb_1936_tsmc_b0_v17[][VM_RAIL_MAX][VL_MAX] = {
	[0] = {
		/* LV0,    LV1,    LV2,    LV3,    LV4,    LV5,    LV6,    LV7 */
		{312000, 416000, 416000, 624000, 624000, 832000, 832000, 1248000}, /* CLUSTER0 */
		...
		{624000, 624000, 624000, 624000, 624000, 667000, 667000, 797000}, /* DDR */
		{208000, 208000, 208000, 312000, 312000, 312000, 312000, 312000}, /* AXI */
		{0, 0, 624000, 624000, 705000, 832000, 832000, 832000}, /* GC3D */
		{0, 208000, 208000, 312000, 312000, 416000, 416000, 416000}, /* GC2D */
		{0, 0, 624000, 624000, 705000, 832000, 832000, 832000}, /* GCSHADER */
		{0, 312000, 416000, 416000, 416000, 416000, 416000, 416000}, /* GCACLK */
	...
	[1] = {
		...
		{624000, 624000, 624000, 624000, 624000, 667000, 667000, 797000}, /* DDR */
		{208000, 312000, 312000, 312000, 312000, 312000, 312000, 312000}, /* AXI */
		{312000, 624000, 624000, 705000, 705000, 832000, 832000, 832000}, /* GC3D */
		{208000, 312000, 312000, 312000, 312000, 416000, 416000, 416000}, /* GC2D */
		{312000, 624000, 624000, 705000, 705000, 832000, 832000, 832000}, /* GCSHADER */
		{208000, 416000, 416000, 416000, 416000, 416000, 416000, 416000}, /* GCACLK */
		{208000, 528000, 528000, 528000, 528000, 528000, 528000, 528000}, /* VPU */
		{208000, 416000, 416000, 416000, 416000, 499000, 499000, 499000}, /* ISP */
		sdh_dvfs,
	},
	[2] = {
		/* LV0,    LV1,    LV2,    LV3,    LV4,    LV5,    LV6,    LV7 */
	...
	[8] = {
		...
		{312000, 528000, 528000, 705000, 705000, 832000, 832000, 832000}, /* GCSHADER */
		{0, 416000, 416000, 416000, 416000, 416000, 416000, 416000}, /* GCACLK */
		{208000, 416000, 528000, 528000, 528000, 528000, 528000, 528000}, /* VPU */
		{208000, 208000, 312000, 312000, 416000, 499000, 499000, 499000}, /* ISP */
		sdh_dvfs,
	},
	[9] = {
	...
	[10] = {
		...
		{0, 312000, 528000, 624000, 705000, 832000, 832000, 832000}, /* GCSHADER */
		{0, 312000, 416000, 416000, 416000, 416000, 416000, 416000}, /* GCACLK */
		{208000, 312000, 528000, 528000, 528000, 528000, 528000, 528000}, /* VPU */
		{208000, 208000, 312000, 312000, 416000, 499000, 499000, 499000}, /* ISP */
		sdh_dvfs,
	},
	[11] = {
...
static int vm_millivolts_1936_svc_tsmc_b0_v17[][VL_MAX] = {
	/*LV0,  LV1,  LV2,  LV3,  LV4,  LV5,  LV6,  LV7 */
	{1000, 1025, 1063, 1088, 1113, 1175, 1250, 1350},/* Profile0 */
	{950, 975, 975, 988, 988, 1050, 1038, 1163},/* Profile1 */
	{950, 975, 975, 988, 988, 1063, 1038, 1175},/* Profile2 */
	{950, 975, 975, 988, 988, 1063, 1050, 1175},/* Profile3 */
	...
	{950, 975, 988, 1013, 1025, 1088, 1100, 1225},/* Profile8 */
	{950, 975, 988, 1013, 1025, 1100, 1100, 1238},/* Profile9 */
	{950, 975, 1000, 1025, 1038, 1100, 1125, 1263},/* Profile10 */
	{950, 988, 1013, 1038, 1050, 1113, 1150, 1275},/* Profile11 */
	{950, 1000, 1025, 1050, 1075, 1125, 1175, 1300},/* Profile12 */
	{975, 1013, 1038, 1063, 1088, 1138, 1200, 1313},/* Profile13 */
	{988, 1013, 1050, 1075, 1100, 1163, 1225, 1338},/* Profile14 */
	{1000, 1025, 1063, 1088, 1113, 1175, 1250, 1350},/* Profile15 */
};
...
#define cp_lv8 cp_msa(VL0, VL2, VL5, VL2)
...
static struct cpmsa_dvc_info cpmsa_dvc_info_1936tsmc_b0_v17[NUM_PROFILES] = {
	[0] = cp_lv8,
	[1] = cp_lv6,
	[2] = cp_lv6,
	[3] = cp_lv6,
...
void adjust_ddr_svc(void)
{
	...
	if (svc_version == SVC_1_11)
		...
		ddr_voltage = ddr_800M_tsmc_b0_v17_svc[uiprofile];
...
int handle_svc_table(void)
{
	...
	if (svc_version == SVC_1_11) {
		...
		millivolts = vm_millivolts_1936_svc_tsmc_b0_v17[uiprofile];
		freqs_cmb = freqs_cmb_1936_tsmc_b0_v17[uiprofile];
	}
...
void handle_svc_cp_table(void)
{
	...
	if (uiYldTableEn == 1) {
		if (svc_version == SVC_1_11)
			...
			cpmsa_dvc_info_cp_temp = cpmsa_dvc_info_1936tsmc_b0_v17;
		...
		if (svc_version == SVC_1_11)
			...
			fillcpdvcinfo(&cpmsa_dvc_info_1936tsmc_b0_v17[uiprofile]);
	}
}
