...
static unsigned long freqs_cmb_1956_tsmc[][VM_RAIL_MAX][VL_MAX] = {
	[0] = {
		...
		/* CLST0 */
		{ 312000, 416000, 416000, 624000, 624000, 832000, 832000, 1248000 },
		/* CLST1 */
		{ 312000, 624000, 832000, 832000, 1057000, 1248000, 1526000, 1803000 },
		/* DDR */
		{ 312000,  312000, 528000, 528000, 624000, 624000, 667000, 797000},
		/* AXI */
		{ 208000,  208000, 208000, 312000, 312000, 312000, 312000, 312000 },
		/* GC3D */
		{      0,  312000, 624000, 624000, 624000, 832000, 832000, 832000 },
		/* GC2D */
		...
		/* VPU */
		{ 208000,  312000, 416000, 500000, 528000, 528000, 528000, 528000 },
		/* ISP */
...
static int vm_millivolts_1956_svc_tsmc[][VL_MAX] = {
	/*LV0, LV1,  LV2,  LV3,  LV4,  LV5,  LV6,  LV7  */
	{1250,  1250, 1250, 1250, 1250, 1250, 1250, 1300},/* Profile0 */
...
int __init setup_pxa1956_dvfs_platinfo(void)
{
	...
	dvc_pxa1956_info.millivolts =
		vm_millivolts_1956_svc_tsmc[0];

	freqs_cmb = freqs_cmb_1956_tsmc[0];
	plat_set_vl_min(0);
