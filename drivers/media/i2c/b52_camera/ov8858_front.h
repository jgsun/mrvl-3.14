...
static struct regval_tab ov8858r2a_res_init[] = {
	{0x0103, 0x01},
	...
	{0x380a, 0x04},
	{0x380b, 0xc8},
	{0x380c, 0x0a},/* 0x07->0x0a*/
	{0x380d, 0x00},/* 0x88->0x00*/
	{0x380e, 0x09},/* 0x04->0x09*/
	{0x380f, 0xb0},/* 0xdc->0xb0*/
	{0x3810, 0x00},
	{0x3811, 0x04},
	{0x3813, 0x02},
	{0x3814, 0x03},
	{0x3815, 0x01},
	{0x3820, 0x06},/*flip 0x00->0x06*/
	{0x3821, 0x61},/*mirror 0x67->0x61*/
	{0x382a, 0x03},
	{0x382b, 0x01},
	{0x3830, 0x08},
	{0x3836, 0x02},
...
static struct regval_tab ov8858r2a_fmt_raw10[] = {
};

static struct regval_tab ov8858r2a_res_2M[] = {
/*Raw 10bit 1632x1224 30fps 4lane 720M bps/lane*/

	{0x0100, 0x01},
};
static struct regval_tab ov8858r2a_res_8M[] = {
	{0x0100, 0x01},
};
static struct regval_tab ov8858r2a_id[] = {
	{0x300b, 0x88, 0xff},
	{0x300c, 0x58, 0xff},
};
static struct regval_tab ov8858r2a_vts[] = {
	{0x380e, 0x09, 0x7f},
	{0x380f, 0xaa, 0xff},
};
static struct regval_tab ov8858r2a_stream_on[] = {
	{0x0100, 0x01, 0xff},
};
static struct regval_tab ov8858r2a_stream_off[] = {
	{0x0100, 0x00, 0xff},
};
static struct regval_tab ov8858r2a_expo[] = {
	{0x3500, 0x00, 0x0f},
	{0x3501, 0x00, 0xff},
	{0x3502, 0x00, 0xff},
};
static struct regval_tab ov8858r2a_ag[] = {
	{0x3508, 0x00, 0xff},
	{0x3509, 0x00, 0xff},
};
static struct regval_tab ov8858r2a_af[] = {
	{0x3618, 0x00, 0xff},
	{0x3619, 0x00, 0xff},
};
static struct regval_tab ov8858r2a_vflip[] = {
	{0x3820, 0x06, 0x6},
};
static struct regval_tab ov8858r2a_hflip[] = {
	{0x3821, 0x00, 0x6},
};

static struct b52_sensor_i2c_attr ov8858r2a_i2c_attr[] = {
	[0] = {
		.reg_len = I2C_16BIT,
		.val_len = I2C_8BIT,
		.addr = 0x36,
...
static struct b52_sensor_mbus_fmt ov8858r2a_fmt = {
...
static struct b52_sensor_resolution ov8858r2a_res[] = {
	[0] = {
		 .width = 3264,
		 .height = 2448,
		 .hts = 0x0794*2,
...
static struct b52_sensor_spec_ops ov8858r2a_ops = {
	.get_pixel_rate = OV8858R2A_get_pixelclock,
	.get_dphy_desc = OV8858R2A_get_dphy_desc,
	.update_otp = OV8858R2A_update_otp,
};
struct b52_sensor_data b52_ov8858_front = {
	.name = "ovt.ov8858r2a_front",
	.type = OVT_SENSOR,
