...
EXPORT_SYMBOL(__cp988_releasecp);
...
EXPORT_SYMBOL(__cp988_holdcp);

bool __cp988_get_status(void)
{
	return !(readl(MPMU_APRR) & MPMU_APRR_CPR);
}
EXPORT_SYMBOL(__cp988_get_status);
